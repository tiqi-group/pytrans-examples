...
from pytrans.abstract_model_electrodes import AbstractTrap
from . import interp
...
class SurfaceTrapDCElectrode(DCElectrode):
    ...
    def __init__(self, interp_name):
        self._interp: interp.TricubicScalarInterpolator1 = interp.interpolators[interp_name]
        super().__init__()
...
class SurfaceTrapRFElectrode(RFElectrode):
    ...
    def __init__(self):
        self._interp: interp.TricubicScalarInterpolator1 = interp.interpolators['pseudo_potential_1V1MHz1amu']
        super().__init__()
