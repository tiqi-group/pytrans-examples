...
def infx_rf_pair_gradient(x, y, z, a, w):
    x, y, z = np.broadcast_arrays(x, y, z)
    return np.stack([np.zeros_like(x),(-(1/((1 + (-0.5*a - y)**2/z**2)*z)) + 1/((1 + (-0.5*a - w - y)**2/z**2)*z))/Pi + (1/((1 + (a/2. - y)**2/z**2)*z) - 1/((1 + (a/2. + w - y)**2/z**2)*z))/Pi,(-((-0.5*a - y)/((1 + (-0.5*a - y)**2/z**2)*z**2)) + (-0.5*a - w - y)/((1 + (-0.5*a - w - y)**2/z**2)*z**2))/Pi + ((a/2. - y)/((1 + (a/2. - y)**2/z**2)*z**2) - (a/2. + w - y)/((1 + (a/2. + w - y)**2/z**2)*z**2))/Pi], axis=-1)

def rf_null_z(a, w):
    """position of RF null for symmetric infinite electrode pair"""
    return Sqrt(a*(a + 2*w))/2.

def rf_saddle_z(a, w):
    """position of RF null for symmetric infinite electrode pair"""
    return Sqrt(a**2 + 2*a*w + 2*Sqrt(a*(a + 2*w))*Abs(a + w))/2.
...
def pseudo_gradient(x, y, z, a, w):
    x, y, z = np.broadcast_arrays(x, y, z)
    return K * np.stack([np.zeros_like(x),2*((((-2*(-0.5*a - y)**2)/((1 + (-0.5*a - y)**2/z**2)**2*z**4) + (2*(-0.5*a - w - y)**2)/((1 + (-0.5*a - w - y)**2/z**2)**2*z**4) + 1/((1 + (-0.5*a - y)**2/z**2)*z**2) - 1/((1 + (-0.5*a - w - y)**2/z**2)*z**2))/Pi + ((2*(a/2. - y)**2)/((1 + (a/2. - y)**2/z**2)**2*z**4) - (2*(a/2. + w - y)**2)/((1 + (a/2. + w - y)**2/z**2)**2*z**4) - 1/((1 + (a/2. - y)**2/z**2)*z**2) + 1/((1 + (a/2. + w - y)**2/z**2)*z**2))/Pi)*((-((-0.5*a - y)/((1 + (-0.5*a - y)**2/z**2)*z**2)) + (-0.5*a - w - y)/((1 + (-0.5*a - w - y)**2/z**2)*z**2))/Pi + ((a/2. - y)/((1 + (a/2. - y)**2/z**2)*z**2) - (a/2. + w - y)/((1 + (a/2. + w - y)**2/z**2)*z**2))/Pi) + (((-2*(-0.5*a - y))/((1 + (-0.5*a - y)**2/z**2)**2*z**3) + (2*(-0.5*a - w - y))/((1 + (-0.5*a - w - y)**2/z**2)**2*z**3))/Pi + ((2*(a/2. - y))/((1 + (a/2. - y)**2/z**2)**2*z**3) - (2*(a/2. + w - y))/((1 + (a/2. + w - y)**2/z**2)**2*z**3))/Pi)*((-(1/((1 + (-0.5*a - y)**2/z**2)*z)) + 1/((1 + (-0.5*a - w - y)**2/z**2)*z))/Pi + (1/((1 + (a/2. - y)**2/z**2)*z) - 1/((1 + (a/2. + w - y)**2/z**2)*z))/Pi)),2*((((-2*(-0.5*a - y)**3)/((1 + (-0.5*a - y)**2/z**2)**2*z**5) + (2*(-0.5*a - w - y)**3)/((1 + (-0.5*a - w - y)**2/z**2)**2*z**5) + (2*(-0.5*a - y))/((1 + (-0.5*a - y)**2/z**2)*z**3) - (2*(-0.5*a - w - y))/((1 + (-0.5*a - w - y)**2/z**2)*z**3))/Pi + ((2*(a/2. - y)**3)/((1 + (a/2. - y)**2/z**2)**2*z**5) - (2*(a/2. + w - y)**3)/((1 + (a/2. + w - y)**2/z**2)**2*z**5) - (2*(a/2. - y))/((1 + (a/2. - y)**2/z**2)*z**3) + (2*(a/2. + w - y))/((1 + (a/2. + w - y)**2/z**2)*z**3))/Pi)*((-((-0.5*a - y)/((1 + (-0.5*a - y)**2/z**2)*z**2)) + (-0.5*a - w - y)/((1 + (-0.5*a - w - y)**2/z**2)*z**2))/Pi + ((a/2. - y)/((1 + (a/2. - y)**2/z**2)*z**2) - (a/2. + w - y)/((1 + (a/2. + w - y)**2/z**2)*z**2))/Pi) + (((-2*(-0.5*a - y)**2)/((1 + (-0.5*a - y)**2/z**2)**2*z**4) + (2*(-0.5*a - w - y)**2)/((1 + (-0.5*a - w - y)**2/z**2)**2*z**4) + 1/((1 + (-0.5*a - y)**2/z**2)*z**2) - 1/((1 + (-0.5*a - w - y)**2/z**2)*z**2))/Pi + ((2*(a/2. - y)**2)/((1 + (a/2. - y)**2/z**2)**2*z**4) - (2*(a/2. + w - y)**2)/((1 + (a/2. + w - y)**2/z**2)**2*z**4) - 1/((1 + (a/2. - y)**2/z**2)*z**2) + 1/((1 + (a/2. + w - y)**2/z**2)*z**2))/Pi)*((-(1/((1 + (-0.5*a - y)**2/z**2)*z)) + 1/((1 + (-0.5*a - w - y)**2/z**2)*z))/Pi + (1/((1 + (a/2. - y)**2/z**2)*z) - 1/((1 + (a/2. + w - y)**2/z**2)*z))/Pi))], axis=-1)
...
def pseudo_hessian(x, y, z, a, w):
    ...
    zz = 2*((((-2*(-0.5*a - y)**3)/((1 + (-0.5*a - y)**2/z**2)**2*z**5) + (2*(-0.5*a - w - y)**3)/((1 + (-0.5*a - w - y)**2/z**2)**2*z**5) + (2*(-0.5*a - y))/((1 + (-0.5*a - y)**2/z**2)*z**3) - (2*(-0.5*a - w - y))/((1 + (-0.5*a - w - y)**2/z**2)*z**3))/Pi + ((2*(a/2. - y)**3)/((1 + (a/2. - y)**2/z**2)**2*z**5) - (2*(a/2. + w - y)**3)/((1 + (a/2. + w - y)**2/z**2)**2*z**5) - (2*(a/2. - y))/((1 + (a/2. - y)**2/z**2)*z**3) + (2*(a/2. + w - y))/((1 + (a/2. + w - y)**2/z**2)*z**3))/Pi)**2 + (((-2*(-0.5*a - y)**2)/((1 + (-0.5*a - y)**2/z**2)**2*z**4) + (2*(-0.5*a - w - y)**2)/((1 + (-0.5*a - w - y)**2/z**2)**2*z**4) + 1/((1 + (-0.5*a - y)**2/z**2)*z**2) - 1/((1 + (-0.5*a - w - y)**2/z**2)*z**2))/Pi + ((2*(a/2. - y)**2)/((1 + (a/2. - y)**2/z**2)**2*z**4) - (2*(a/2. + w - y)**2)/((1 + (a/2. + w - y)**2/z**2)**2*z**4) - 1/((1 + (a/2. - y)**2/z**2)*z**2) + 1/((1 + (a/2. + w - y)**2/z**2)*z**2))/Pi)**2 + (((-8*(-0.5*a - y)**5)/((1 + (-0.5*a - y)**2/z**2)**3*z**8) + (8*(-0.5*a - w - y)**5)/((1 + (-0.5*a - w - y)**2/z**2)**3*z**8) + (14*(-0.5*a - y)**3)/((1 + (-0.5*a - y)**2/z**2)**2*z**6) - (14*(-0.5*a - w - y)**3)/((1 + (-0.5*a - w - y)**2/z**2)**2*z**6) - (6*(-0.5*a - y))/((1 + (-0.5*a - y)**2/z**2)*z**4) + (6*(-0.5*a - w - y))/((1 + (-0.5*a - w - y)**2/z**2)*z**4))/Pi + ((8*(a/2. - y)**5)/((1 + (a/2. - y)**2/z**2)**3*z**8) - (8*(a/2. + w - y)**5)/((1 + (a/2. + w - y)**2/z**2)**3*z**8) - (14*(a/2. - y)**3)/((1 + (a/2. - y)**2/z**2)**2*z**6) + (14*(a/2. + w - y)**3)/((1 + (a/2. + w - y)**2/z**2)**2*z**6) + (6*(a/2. - y))/((1 + (a/2. - y)**2/z**2)*z**4) - (6*(a/2. + w - y))/((1 + (a/2. + w - y)**2/z**2)*z**4))/Pi)*((-((-0.5*a - y)/((1 + (-0.5*a - y)**2/z**2)*z**2)) + (-0.5*a - w - y)/((1 + (-0.5*a - w - y)**2/z**2)*z**2))/Pi + ((a/2. - y)/((1 + (a/2. - y)**2/z**2)*z**2) - (a/2. + w - y)/((1 + (a/2. + w - y)**2/z**2)*z**2))/Pi) + (((-8*(-0.5*a - y)**4)/((1 + (-0.5*a - y)**2/z**2)**3*z**7) + (8*(-0.5*a - w - y)**4)/((1 + (-0.5*a - w - y)**2/z**2)**3*z**7) + (10*(-0.5*a - y)**2)/((1 + (-0.5*a - y)**2/z**2)**2*z**5) - (10*(-0.5*a - w - y)**2)/((1 + (-0.5*a - w - y)**2/z**2)**2*z**5) - 2/((1 + (-0.5*a - y)**2/z**2)*z**3) + 2/((1 + (-0.5*a - w - y)**2/z**2)*z**3))/Pi + ((8*(a/2. - y)**4)/((1 + (a/2. - y)**2/z**2)**3*z**7) - (8*(a/2. + w - y)**4)/((1 + (a/2. + w - y)**2/z**2)**3*z**7) - (10*(a/2. - y)**2)/((1 + (a/2. - y)**2/z**2)**2*z**5) + (10*(a/2. + w - y)**2)/((1 + (a/2. + w - y)**2/z**2)**2*z**5) + 2/((1 + (a/2. - y)**2/z**2)*z**3) - 2/((1 + (a/2. + w - y)**2/z**2)*z**3))/Pi)*((-(1/((1 + (-0.5*a - y)**2/z**2)*z)) + 1/((1 + (-0.5*a - w - y)**2/z**2)*z))/Pi + (1/((1 + (a/2. - y)**2/z**2)*z) - 1/((1 + (a/2. + w - y)**2/z**2)*z))/Pi))
